...
export async function initializeSchema() {
  ...
  // Anonymous product-analytics events from the iOS client (AnalyticsService).
  // Keyed only by an app-generated install UUID — no PII. `props` is stored
  // as-is (validated shape, never evaluated). See api/events.js.
  await pool.query(`
