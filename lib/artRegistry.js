...
The image fills the WHOLE board cell, so use transparent padding to set how big the saddle looks — paint the saddle itself at roughly two-thirds width, centered, with the rest transparent. The app rotates the image 90° for horizontal snakes. Give it a strong silhouette that reads at small size: leather browns, gold trim, raised cantle at the back, horn at the front.
