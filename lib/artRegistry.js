...
${STYLE}`,
  ...
  piece('saddle', 'Cowboy saddle marker', 220, {
    state: 'placeholder',
    instructions: `NEEDED — currently drawn procedurally in-code. A small western saddle overlay that sits on a frog's back to mark it as able to ride snakes (Cowboy chapter mechanic).
Suggested size: ~512×512px, transparent PNG, top-down/three-quarter view. It is drawn small (roughly a third of a cell) on top of the frog sprite, so it must read at ~30px: strong silhouette, warm leather browns, maybe a touch of rope.
${STYLE}`,
  }),
