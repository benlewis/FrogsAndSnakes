...
${STYLE}`,
  ...
  music('music_theme1',   'Music — theme 1',         371, 'One of three general gameplay themes that play in rotation across the main menu and the Starter/Intermediate/Advanced chapters (and the Super chapter cycles all themes). Calm, sunny, loopable — think kalimba/marimba/acoustic over light ambience. The three themes should feel like one family with gentle variety.'),
  music('music_theme2',   'Music — theme 2',         372, 'Second of three rotating gameplay themes (menu + Starter/Intermediate/Advanced, and Super). A sibling to theme 1 — same relaxed puzzle mood and instrument palette, a touch different in melody/energy so the rotation does not feel repetitive. Must loop seamlessly.'),
  music('music_theme3',   'Music — theme 3',         373, 'Third of three rotating gameplay themes (menu + Starter/Intermediate/Advanced, and Super). Rounds out the set — same family as themes 1 and 2, its own melody, still mellow enough to sit under sound effects for long sessions. Must loop seamlessly.'),
